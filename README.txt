...
==================================================================
Data Cleaned and Prepared by Brian Sewell
...
- 'run_analysis.R': Script used to exctract, clean and manipulate original data.

- 'CodeBook.md': Markdown describing each step as to how we downloaded and cleaned the orginal data including code.

- 'x.csv': Prepared data from 'Training set' and 'Test set' including row and column names.

- 'xSummary.csv': Average of columns in 'x.csv' groped by 'Subject' and 'Activity'.

The following columns are available for the train and test data. Their descriptions are equivalent. 
